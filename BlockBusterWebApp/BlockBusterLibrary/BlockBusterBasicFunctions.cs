...
namespace BlockBusterLibrary
{
    ...
    public class BlockBusterBasicFunctions
    {
        ...
        /// <summary>
        /// Retrieves all of the <see cref="Transaction"/>s in
        /// the SE407 BlockBuster database where the movies are checked out
        /// </summary>
        /// <returns>A list of all transactions, or null if no transactions exist</returns>
